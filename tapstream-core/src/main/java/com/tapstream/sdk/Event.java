...
public class Event {
    ...
    /**
     * Only to be used for creating IAB purchase events from Play Store JSON.
     *
    ...
    /**
     * Add a purchase receipt to this event to enable purchase validation.
     *
     * @param purchaseDataJson
     * @param signature
     */
    public void setReceipt(String purchaseDataJson, String signature) {
        JSONObject receipt = new JSONObject();
        receipt.put("purchase_data", purchaseDataJson);
        receipt.put("signature", signature);
        params.putWithoutTruncation(RECEIPT_BODY, receipt.toString());
